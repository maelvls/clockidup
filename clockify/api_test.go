	...
	t.Run("the requested project id exists", func(t *testing.T) {
		...
		assert.Equal(t, []Project{{
			...
			Memberships: []Memberships{{
				...
				HourlyRate:       interface{}(nil),
				CostRate:         interface{}(nil),
				TargetID:         "60f4681a0fdfe402db9afae9",
				MembershipType:   "PROJECT",
				MembershipStatus: "ACTIVE",
			}},
			Color:      "#FF5722",
...
func TestClockify_TimeEntries(t *testing.T) {
	...
	t.Run("the requested workspace and user exist", func(t *testing.T) {
		...
		got, gotErr := clockify.TimeEntries(
			...
			// Note that all times returned by the Clockify API are UTC.
		...
		assert.Equal(t, []TimeEntry([]TimeEntry{{
			...
			TimeInterval: TimeInterval{
				Start:    mustParse("2021-07-03 15:30:00"),
				End:      mustParse("2021-07-03 16:45:00"),
				Duration: "PT1H15M",
			},
			WorkspaceID:       "60e086c24f27a949c058082e",
			IsLocked:          false,
			...
			ProjectID:   "60e0a9cf5f596c5a7d10d821",
			TimeInterval: TimeInterval{
				Start:    mustParse("2021-07-03 14:45:00"),
				End:      mustParse("2021-07-03 15:30:00"),
				Duration: "PT45M",
			},
			WorkspaceID:       "60e086c24f27a949c058082e",
			IsLocked:          false,
			...
			ProjectID:   "60e0a9cf5f596c5a7d10d821",
			TimeInterval: TimeInterval{
				Start:    mustParse("2021-07-03 14:30:00"),
				End:      mustParse("2021-07-03 14:45:00"),
				Duration: "PT15M",
			},
			WorkspaceID:       "60e086c24f27a949c058082e",
			IsLocked:          false,
			...
			ID:          "60f4681ba18d2d6d98bdab2c",
			Description: "work on project-2",
			TagIds:      []interface{}{},
			UserID:      "60e086c24f27a949c058082d",
			Billable:    true,
			TaskID:      "",
			ProjectID:   "60f4681a0fdfe402db9afae9",
			TimeInterval: TimeInterval{
				Start:    mustParse("2021-07-03 10:30:00"),
				End:      mustParse("2021-07-03 11:15:00"),
				Duration: "PT45M",
			},
			WorkspaceID:       "60e086c24f27a949c058082e",
			IsLocked:          false,
